class PaytmInitiateTransactionResponseModel {
  Head? head;
  Body? body;

  PaytmInitiateTransactionResponseModel({this.head, this.body});

  PaytmInitiateTransactionResponseModel.fromJson(Map<String, dynamic> json) {
